---
loom-container: wsl-test
---

# 02 - WSL Execution Test

This note targets the `wsl-test` group, which is configured to execute code blocks inside Windows Subsystem for Linux (WSL).
