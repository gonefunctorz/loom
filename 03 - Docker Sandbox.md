---
loom-container: docker-test
---

# 03 - Docker Sandbox Test

This note targets the `docker-test` group, which is configured to build and run a custom Docker container.
