---
loom-container: qemu-test
---

# 05 - QEMU Sandbox Test

This note targets the `qemu-test` group, which is configured to execute code blocks inside a QEMU-managed environment over SSH.
